...
function(add_plot SHOOTOUT_DRIVER_NAME SHOOTOUT_TEST_NAME SHOOTOUT_PLOT_NAME)
  set(SHOOTOUT_ARGS_FLAGS       )
  set(SHOOTOUT_ARGS_ONE_VALUE   SCENARIO_NAME STEP_NAME)
  ...
  if(NOT SHOOTOUT_ITERATIONS)
    set(SHOOTOUT_ITERATIONS 100000)
  endif()
  ...
  if(NOT TARGET ${SHOOTOUT_DATA_NAME})
    add_custom_target(${SHOOTOUT_DATA_NAME}
      COMMAND LD_PRELOAD=lib/lib${SHOOTOUT_DRIVER_NAME}-${SHOOTOUT_TEST_NAME}.so bin/${SHOOTOUT_EXECUTABLE_NAME} data/${SHOOTOUT_BENCHMARK_NAME} ${SHOOTOUT_ITERATIONS} ${SHOOTOUT_SCENARIO_NAME}
    )
...
function(add_plots SHOOTOUT_DRIVER_NAME SHOOTOUT_TEST_NAME SHOOTOUT_PLOT_NAME)
  ...
  foreach(SHOOTOUT_SCENARIO IN LISTS SHOOTOUT_SCENARIOS)
    foreach(SHOOTOUT_STEP IN LISTS SHOOTOUT_STEPS)
      add_plot(${SHOOTOUT_DRIVER_NAME} ${SHOOTOUT_TEST_NAME} ${SHOOTOUT_PLOT_NAME} STEP_NAME ${SHOOTOUT_STEP} SCENARIO_NAME ${SHOOTOUT_SCENARIO})
    endforeach()
  endforeach()
endfunction()
